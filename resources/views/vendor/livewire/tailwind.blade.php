...
@if ($paginator->hasPages())
 <div class="max-w-screen-xl mx-auto px-6 md:px-16 pt-10">
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm text-fontDark leading-5 dark:text-fontLight">
                        ...
                        <span>
                            ...
                            @if ($paginator->onFirstPage())
                                <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                                    <span class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-fontLight dark:text-fontDark bg-bgDark-400 border border-bgDark-400 cursor-default rounded-l-md leading-5 dark:bg-white dark:border-gray-300" aria-hidden="true">
