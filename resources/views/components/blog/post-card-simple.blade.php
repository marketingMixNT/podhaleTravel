...
<div class="w-full flex flex-col justify-between   gap-8 group grow ">
    {{-- IMG --}}
    <div class="w-full">
        <a wire:navigate href="{{ route('blog.show', $post->slug) }}">
            <div class="overflow-hidden">
                ...
                <img src="{{ $post->getThumbnailUrl() }}" alt="{{ $post->title }}"
                    class="group-hover:scale-110 duration-500  object-cover w-full aspect-[4/3] sm:aspect-video lg:aspect-[4/3]"
